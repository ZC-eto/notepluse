...
> **产品**：本地 Markdown 工作区「诺麦笔记」；Markdown 是唯一真源，任务仅来自显式任务组。  
...
**诺麦笔记不是把 Markdown 套进项目管理壳子；它是一张可书写的纸面，在同一条“工作线”上把笔记、任务、日期和进度投影出来。**
...
```text
┌─────────────────────────────────────────────────────────────────────────────────────────────┐
│ Product bar: 诺麦笔记 · [⌘K 搜索/命令]             同步/保存状态 · Theme · Settings         │ 48
├───────────┬───────────────────────────────────────────┬─────────────────────────────────────┤
